  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow w-full">
      <div className="px-4 py-5 sm:px-6 bg-slate-50">
        <span className="text-red-500 font-bold px-2 py-1 rounded text-sm sm:text-base md:text-lg lg:text-xl">
          WE
        </span>
        <span className="ml-2 text-lg font-bold sm:text-xl md:text-2xl lg:text-3xl">
          {props.heading}
        </span>
      </div>
