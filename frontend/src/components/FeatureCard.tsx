  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg bg-white shadow w-full">
      <div className="px-4 py-5 sm:px-6 bg-neutral-50">
        <span className="text-neutral-950 text-4xl font-bold px-2 py-1 rounded ">
          We
        </span>
      ...
      <div className="flex-grow font-medium hover:scale-105 bg-neutral-50 px-4 py-5 sm:p-6 text-base sm:text-lg md:text-xl lg:text-xl">
        {props.content}
      </div>
